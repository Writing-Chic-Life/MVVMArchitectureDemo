...
#import "YYRNewFeatureViewController.h"

@interface YYRNewFeatureViewController ()<UIScrollViewDelegate>
...
/// viewModel
@property (nonatomic, readwrite, strong) YYRNewFeatureViewModel *viewModel;

@end

@implementation YYRNewFeatureViewController
...
- (void)clickStartButton {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:YYRSwitchRootViewControllerNotification object:nil userInfo:@{YYRSwitchRootViewControllerUserInfoKey:@(YYRSwitchRootViewControllerFromTypeNewFeature)}];
}
...
- (void)_prepareScrollView {
    ...
    /// 适配 iOS11
    YYRAdjustsScrollViewInsets_Never(self.scrollView);
}
...
- (UIButton *)startButton {
    if (_startButton == nil) {
        ...
        [_startButton setBackgroundImage:YYRImageNamed(@"new_feature_finish_button") forState:UIControlStateNormal];
