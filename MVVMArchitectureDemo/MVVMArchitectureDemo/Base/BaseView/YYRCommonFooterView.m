...
@end
@implementation YYRCommonFooterView

#pragma mark - 公共方法
+ (instancetype)footerViewWithTableView:(UITableView *)tableView {
    static NSString *ID = @"CommonFooter";
    YYRCommonFooterView *footer = [tableView dequeueReusableHeaderFooterViewWithIdentifier:ID];
    if (footer == nil) {
        // 缓存池中没有, 自己创建
