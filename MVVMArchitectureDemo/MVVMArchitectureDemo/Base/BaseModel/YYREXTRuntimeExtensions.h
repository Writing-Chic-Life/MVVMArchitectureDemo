...
typedef enum {
     ...
     */
   yyr_propertyMemoryManagementPolicyAssign = 0,
    
    /**
     * The value is retained.
     */
   yyr_propertyMemoryManagementPolicyRetain,
    
    /**
     * The value is copied.
     */
   yyr_propertyMemoryManagementPolicyCopy
}yyr_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     */
   yyr_propertyMemoryManagementPolicy memoryManagementPolicy;
