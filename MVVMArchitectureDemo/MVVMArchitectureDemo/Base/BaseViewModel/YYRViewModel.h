...
FOUNDATION_EXTERN NSString *const YYRViewModelIDKey;
/// 传递导航栏title的key：例如 导航栏的title...
FOUNDATION_EXTERN NSString *const YYRViewModelTitleKey;
/// 传递数据模型的key：例如 商品模型的传递 用户模型的传递...
FOUNDATION_EXTERN NSString *const YYRViewModelUtilKey;
/// 传递webView Request的key：例如 webView request...
FOUNDATION_EXTERN NSString *const YYRViewModelRequestKey;

@protocol YYRViewModelServices;

@interface YYRViewModel : NSObject
...
@property (nonatomic, readonly, strong) id<YYRViewModelServices> services;
