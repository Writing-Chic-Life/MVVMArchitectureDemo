//
//  YYRSegmentedControlController.m
...
#import "YYRSegmentedControlController.h"

@interface YYRSegmentedControlController ()
...
@implementation YYRSegmentedControlController
...
static void *YYRSegmentedControlItemKey = &YYRSegmentedControlItemKey;

@implementation UIViewController (YYRSegmentedControlItem)

- (NSString *)segmentedControlItem {
    return objc_getAssociatedObject(self, YYRSegmentedControlItemKey);
}

- (void)setSegmentedControlItem:(NSString *)segmentedControlItem {
    objc_setAssociatedObject(self, YYRSegmentedControlItemKey, segmentedControlItem, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
