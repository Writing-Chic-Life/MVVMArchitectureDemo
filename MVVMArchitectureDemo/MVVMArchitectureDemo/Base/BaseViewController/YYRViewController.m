...
@interface YYRViewController ()

// viewModel
@property (nonatomic, readwrite, strong) YYRViewModel *viewModel;
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    YYRViewController *viewController = [super allocWithZone:zone];
...
- (instancetype)initWithViewModel:(YYRViewModel *)viewModel {
    self = [super init];
    if (self) {
...
- (void)viewDidLoad {
    ...
    /// backgroundColor
    self.view.backgroundColor = YYR_MAIN_BACKGROUNDCOLOR;
